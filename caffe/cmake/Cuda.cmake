...
function(caffe_select_nvcc_arch_flags out_variable)
  # List of arch names
  set(__archs_names "Fermi" "Kepler" "Maxwell" "Pascal" "Turing" "Volta" "All" "Manual")
  ...
  #foreach(__arch ${CUDA_ARCH_NAME})
  #  if(NOT "${__archs_names}" MATCHES __arch)
  #    message(FATAL_ERROR "${__archs_names} ${__arch} architeture names is not supported.")
  #  endif()
  #endforeach()
  ...
  elseif(${CUDA_ARCH_NAME} STREQUAL "Manual")
    ...
    if(${CUDA_ARCH_NAME} MATCHES "Fermi")
      list(APPEND __cuda_arch_bin "20 21(20)")
    endif()
    if(${CUDA_ARCH_NAME} MATCHES "Kepler")
      list(APPEND __cuda_arch_bin "30 35")
    endif()
    if(${CUDA_ARCH_NAME} MATCHES "Maxwell")
      list(APPEND __cuda_arch_bin "50")
    endif()
    if(${CUDA_ARCH_NAME} MATCHES "Pascal")
      list(APPEND __cuda_arch_bin "60 61")
    endif()
    if(${CUDA_ARCH_NAME} MATCHES "Turing")
      list(APPEND __cuda_arch_bin "75")
    endif()
    if(${CUDA_ARCH_NAME} MATCHES "Volta")
      list(APPEND __cuda_arch_bin "70")
    endif()
  endif()
